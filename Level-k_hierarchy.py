...
for j in range(count_list[0]):
    probability = level_k_probabilities(0, 0)
    random_number = np.random.uniform(0, 1)
    if random_number <= probability[0]:
        action0 = 0
    else:
        action0 = 1
    probability1 = level_k_probabilities(0, 1)
...
for j in range(count_list[1]):
    ...
    if random_number <= probability[0]:
        ...
        action0 = 1
    probability1 = level_k_probabilities(1, 1)
    random_number1 = np.random.uniform(0, 1)
    if random_number1 <= probability1[0]:
        action1 = 0
    else:
...
for j in range(count_list[2]):
    ...
    if random_number <= probability[0]:
        ...
        action0 = 1
    probability1 = level_k_probabilities(2, 1)
    random_number1 = np.random.uniform(0, 1)
    if random_number1 <= probability1[0]:
        action1 = 0
    else:
...
for j in range(count_list[3]):
    ...
    if random_number <= probability[0]:
        ...
        action0 = 1
    probability1 = level_k_probabilities(3, 1)
    random_number1 = np.random.uniform(0, 1)
    if random_number1 <= probability1[0]:
        action1 = 0
    else:
...
total_payoff=0
for j in range(count_list[0]):
    probability = level_k_probabilities(1, 0)
    random_number = np.random.uniform(0, 1)
    if random_number <= probability[0]:
        action0 = 0
    else:
...
total_payoff=0
for j in range(count_list[0]):
    probability = level_k_probabilities(2, 0)
    random_number = np.random.uniform(0, 1)
    if random_number <= probability[0]:
        action0 = 0
    else:
...
total_payoff=0
for j in range(count_list[0]):
    probability = level_k_probabilities(3, 0)
    random_number = np.random.uniform(0, 1)
    if random_number <= probability[0]:
        action0 = 0
    else:
...
total_payoff=0
for j in range(count_list[0]):
    probability = level_k_probabilities(0, 1)
    random_number = np.random.uniform(0, 1)
    if random_number <= probability[0]:
        action0 = 0
    else:
        action0 = 1
    probability1 = level_k_probabilities(0, 0)
    random_number1 = np.random.uniform(0, 1)
    if random_number1 <= probability1[0]:
        action1 = 0
    else:
...
for j in range(count_list[1]):
    ...
    if random_number <= probability[0]:
        ...
        action0 = 1
    probability1 = level_k_probabilities(1, 0)
    random_number1 = np.random.uniform(0, 1)
    if random_number1 <= probability1[0]:
        action1 = 0
    else:
...
for j in range(count_list[2]):
    ...
    if random_number <= probability[0]:
        ...
        action0 = 1
    probability1 = level_k_probabilities(2, 0)
    random_number1 = np.random.uniform(0, 1)
    if random_number1 <= probability1[0]:
        action1 = 0
    else:
...
for j in range(count_list[3]):
    ...
    if random_number <= probability[0]:
        ...
        action0 = 1
    probability1 = level_k_probabilities(3, 0)
    random_number1 = np.random.uniform(0, 1)
    if random_number1 <= probability1[0]:
        action1 = 0
    else:
...
total_payoff=0
for j in range(count_list[0]):
    probability = level_k_probabilities(1, 1)
    random_number = np.random.uniform(0, 1)
    if random_number <= probability[0]:
        action0 = 0
    else:
...
total_payoff=0
for j in range(count_list[0]):
    probability = level_k_probabilities(2, 1)
    random_number = np.random.uniform(0, 1)
    if random_number <= probability[0]:
        action0 = 0
    else:
...
total_payoff=0
for j in range(count_list[0]):
    probability = level_k_probabilities(3, 1)
    random_number = np.random.uniform(0, 1)
    if random_number <= probability[0]:
        action0 = 0
    else:
