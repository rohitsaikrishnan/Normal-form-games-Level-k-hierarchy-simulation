...
def level_k_probabilities_2(k,player,lamda2=0.56):
    ...
    if player == 0:
        sum_1 = np.exp(
            lamda2 * (level_k_probabilities_1(k - 1, (player + 1) % 2, lamda = 0.05)[0] * normal_form_game_player[0][0][0] +
                      level_k_probabilities_1(k - 1, (player + 1) % 2, lamda = 0.05)[1] * normal_form_game_player[0][1][0] +
                      level_k_probabilities_1(k - 1, (player + 1) % 2, lamda = 0.05)[2] * normal_form_game_player[0][2][0]))

        sum_2 = np.exp(
            lamda2 * (level_k_probabilities_1(k - 1, (player + 1) % 2, lamda = 0.05)[0] * normal_form_game_player[1][0][0] +
            level_k_probabilities_1(k - 1, (player + 1) % 2, lamda = 0.05)[1] * normal_form_game_player[1][1][0] +
                level_k_probabilities_1(k - 1, (player + 1) % 2, lamda = 0.05)[2] * normal_form_game_player[1][2][0]))
        sum_3 = np.exp(
            lamda2 * (level_k_probabilities_1(k - 1, (player + 1) % 2, lamda = 0.05)[0] * normal_form_game_player[2][0][0] +
                      level_k_probabilities_1(k - 1, (player + 1) % 2, lamda = 0.05)[1] * normal_form_game_player[2][1][0] +
                      level_k_probabilities_1(k - 1, (player + 1) % 2, lamda = 0.05)[2] * normal_form_game_player[2][2][0]))
    else:
        sum_1 = np.exp(
            lamda2 * (level_k_probabilities_1(k - 1, (player + 1) % 2, lamda = 0.05)[0] * normal_form_game_player[0][0][1] +
                      level_k_probabilities_1(k - 1, (player + 1) % 2, lamda = 0.05)[1] * normal_form_game_player[0][1][1] +
                      level_k_probabilities_1(k - 1, (player + 1) % 2, lamda = 0.05)[2] * normal_form_game_player[0][2][1]))

        sum_2 = np.exp(
            lamda2 * (level_k_probabilities_1(k - 1, (player + 1) % 2, lamda = 0.05)[0] * normal_form_game_player[1][0][1] +
                      level_k_probabilities_1(k - 1, (player + 1) % 2, lamda = 0.05)[1] * normal_form_game_player[1][1][1] +
                      level_k_probabilities_1(k - 1, (player + 1) % 2, lamda = 0.05)[2] * normal_form_game_player[1][2][1]))
        sum_3 = np.exp(
            lamda2 * (level_k_probabilities_1(k - 1, (player + 1) % 2, lamda = 0.05)[0] * normal_form_game_player[2][0][1] +
                      level_k_probabilities_1(k - 1, (player + 1) % 2, lamda = 0.05)[1] * normal_form_game_player[2][1][1] +
                      level_k_probabilities_1(k - 1, (player + 1) % 2, lamda = 0.05)[2] * normal_form_game_player[2][2][1]))
...
print(ind)
width = 0.8/3
plt.bar(ind, level0_p2, width, label='level-0')
plt.bar(ind + width, level1_p2, width,
        label='level-1')
